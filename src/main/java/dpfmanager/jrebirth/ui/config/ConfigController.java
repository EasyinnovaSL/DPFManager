...
import dpfmanager.jrebirth.ui.config.sub.SubConfig1Controller;
import dpfmanager.jrebirth.ui.config.sub.SubConfig2Controller;
import dpfmanager.jrebirth.ui.config.sub.SubConfig3Controller;
import dpfmanager.jrebirth.ui.config.sub.SubConfig4Controller;
import dpfmanager.jrebirth.ui.config.sub.SubConfig6Controller;
...
public class ConfigController extends DefaultController<ConfigModel, ConfigView> {
  ...
  private void saveConfig() {
    ...
    if (value != null) {
      ...
      file = fileChooser.showSaveDialog(RebirthApp.getMyStage());
    }
