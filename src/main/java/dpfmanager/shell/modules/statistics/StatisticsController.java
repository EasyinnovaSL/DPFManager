/**
 * <h1>ReportController.java</h1> <p> This program is free software: you can redistribute it
 ...
 */
@Controller(BasicConfig.MODULE_STATISTICS)
public class StatisticsController extends DpfSpringController {
