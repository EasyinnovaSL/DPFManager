/**
 * <h1>ControllerMacOS.java</h1> <p> This program is free software: you can redistribute it
...
public class ControllerMacOS extends Controller {
  ...
  private String toCronLine(PeriodicCheck check) {
    String dpfCommand = "/Applications/DPF\\ Manager.app/Contents/MacOS/DPF\\ Manager " + buildCommandArguments(check);
    String line = "";
