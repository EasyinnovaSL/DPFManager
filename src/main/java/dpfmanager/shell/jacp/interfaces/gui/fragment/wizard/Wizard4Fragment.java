...
import dpfmanager.shell.jacp.interfaces.gui.component.config.ConfigModel;
...
public class Wizard4Fragment {
  ...
  public dpfmanager.shell.jacp.interfaces.gui.component.config.ConfigModel getModel() {
    return model;
  }

  public void setModel(dpfmanager.shell.jacp.interfaces.gui.component.config.ConfigModel model) {
    this.model = model;
  }
