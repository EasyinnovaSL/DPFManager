...
import dpfmanager.shell.gui.reimplemented.NumberTextField;
...
public class Gui extends UserInterface {
  ...
  public void getAutofixes(Scene scene) throws Exception {
    ...
    for (String className : classes) {
      autofix fix = (autofix) Class.forName(TiffConformanceChecker.getAutofixesClassPath() + "." + className).newInstance();
