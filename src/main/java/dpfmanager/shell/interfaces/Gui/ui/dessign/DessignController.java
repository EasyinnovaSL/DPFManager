    ...
    getView().getSelectButton().setOnAction(new EventHandler<ActionEvent>() {
      ...
      public void handle(ActionEvent event) {
        ...
        if (c.getValue() == "File") {
          ...
          List<File> files = fileChooser.showOpenMultipleDialog(MainApp.getMyStage());
          if (files != null) {
            String sfiles = "";
            for (File file : files) {
          ...
          File directory = folderChooser.showDialog(MainApp.getMyStage());
          if (directory != null) {
    ...
    getView().getCheckFilesButton().setOnAction(new EventHandler<ActionEvent>() {
      ...
      public void handle(ActionEvent event) {
        ...
        if (radio == null) {
          ...
          alert.initOwner(MainApp.getMyStage());
          alert.showAndWait();
          return;
        }
    ...
    getView().getImportButton().setOnAction(new EventHandler<ActionEvent>() {
      ...
      public void handle(ActionEvent event) {
        ...
        if (value != null) {
          ...
          file = fileChooser.showOpenDialog(MainApp.getMyStage());
        }
        ...
        if (radio != null) {
          ...
          if (result.get() == buttonYes) {
            ...
            if (file.delete()) {
              ...
              alert2.initOwner(MainApp.getMyStage());
              alert2.showAndWait();
            }
          }
        } else {
