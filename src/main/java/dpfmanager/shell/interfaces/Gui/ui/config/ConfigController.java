...
import dpfmanager.shell.interfaces.Gui.ui.config.sub.SubConfig1Controller;
import dpfmanager.shell.interfaces.Gui.ui.config.sub.SubConfig2Controller;
import dpfmanager.shell.interfaces.Gui.ui.config.sub.SubConfig3Controller;
import dpfmanager.shell.interfaces.Gui.ui.config.sub.SubConfig4Controller;
import dpfmanager.shell.interfaces.Gui.ui.config.sub.SubConfig6Controller;
...
public class ConfigController extends DefaultController<ConfigModel, ConfigView> {
  ...
  private void saveConfig() {
    ...
    if (value != null) {
      ...
      file = fileChooser.showSaveDialog(MainApp.getMyStage());
    }
