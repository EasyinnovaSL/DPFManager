 ...
 */
@Perspective(id = GuiConfig.PRESPECTIVE_DESSIGN,
    name = GuiConfig.PRESPECTIVE_DESSIGN,
    active = false,
    components = {
        GuiConfig.COMPONENT_TOP,
        GuiConfig.COMPONENT_DESSIGN,
        GuiConfig.COMPONENT_BOTTOM
    }
)
public class DessignPrespective extends DpfAbstractPrespective {
  ...
  public void onShow() {
    ...
    context.getManagedFragmentHandler(TopFragment.class).getController().setCurrentToggle(TopFragment.ButDessign);
  }
  ...
  public void onStartPerspective(PerspectiveLayout perspectiveLayout, FXComponentLayout layout, ResourceBundle resourceBundle) {
    ...
    perspectiveLayout.registerTargetLayoutComponent(GuiConfig.TARGET_CONTAINER_DESSIGN, centerPane);
