/**
 * <h1>ConfigPerspective.java</h1> <p> This program is free software: you can redistribute it
 ...
 */
@Perspective(id = GuiConfig.PERSPECTIVE_CONFIG,
    name = GuiConfig.PERSPECTIVE_CONFIG,
    active = false,
    components = {
...
public class ConfigPerspective extends DpfAbstractPerspective {
