/**
 * <h1>RulesType.java</h1> <p> This program is free software: you can redistribute it and/or modify
...
public class RulesType {
  ...
  public void removeRule(String id) {
    RuleType delete = null;
    for (RuleType ruleItem : rule) {
      if (ruleItem.getId().equals(id)) {
        delete = ruleItem;
      }
    }
    if (delete != null) {
