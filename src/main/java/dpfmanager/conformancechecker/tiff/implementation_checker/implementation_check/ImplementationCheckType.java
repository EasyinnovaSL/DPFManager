/**
 * <h1>ImplementationCheckType.java</h1> <p> This program is free software: you can redistribute it
...
/**
 * <p>Clase Java para implementation_checkType complex type.
 * 
...
@XmlType(name = "implementation_checkType", propOrder = {
    "name",
    "ruleResult"
})
public class ImplementationCheckType {

    @XmlElement(required = true)
    protected String name;
    @XmlElement(name = "rule_result", required = true)
